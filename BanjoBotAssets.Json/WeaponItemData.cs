...
{
    [NamedItemData("Weapon")]
    public sealed class WeaponItemData : NamedItemData
    {
    ...
    /// <summary>
    /// Only included for ranged weapons and ranged weapon schematics
    /// </summary>
    ...
    /// <summary>
    /// Only included for melee weapons and melee weapon schematics (i.e. RngMax is zero)
    /// </summary>
